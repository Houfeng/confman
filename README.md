# 一句话介绍
confman 是一个强大的配置文件加载器，无论你喜欢 yaml 、json、cson、ini、properties、plist、toml、xml 还是 js，都能满足你的愿望，并且更加简单、更加强大。
...
# 支持的特性
- 支持多种配置文件格式，默认包括 yaml/json/cson/ini/properties/plist/toml/xml/js 
